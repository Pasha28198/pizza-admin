...
import logo_compact from '../../../assets/images/favicon.png';
        ...
        <Fragment>
            <div className="page-sidebar">
                <div className="main-header-left d-none d-lg-block">
                    <div className="logo-wrapper compactLogo ml-5">
                        <a href="/">
                            <img className="blur-up lazyloaded" width="50px" src={logo_compact} alt="" />
                            <img className="blur-up lazyloaded" width="50px" src={logo} alt="" />
                        </a>
                    </div>
                </div>
